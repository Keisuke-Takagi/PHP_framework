...
<header id="header">
  ...
  if(isset($_SESSION['EMAIL']) && isset($_SESSION['COUNT'])){header('Location: http://localhost/bookapp/books/index/mainpage');
    try {
  ...
  }else{header('Location: http://localhost/bookapp/users/index/registraton');
  }
  ?>
  </div>
</body>
